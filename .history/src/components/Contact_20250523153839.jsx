    ...
    <div className="max-w-5xl mx-auto p-4 mt-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <div>
            <p className="text-gray-700 font-medium">📞 Phone: <span className="font-normal">+254 712 345678</span></p>
            <p className="text-gray-700 font-medium">📧 Email: <span className="font-normal">support@malishusclothify.com</span></p>
            <p className="text-gray-700 font-medium">📍 Location: <span className="font-normal">Nairobi, Kenya</span></p>
          </div>
        </div>
