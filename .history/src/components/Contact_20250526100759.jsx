        ...
        <div className="space-y-4">
          ...
          <div>
            <p className="text-gray-700 font-medium">
              📞 Phone: <a href="tel:+254712345678" className="font-normal text-purple-600 hover:underline">+254 712 345678</a>
            </p>
            <p className="text-gray-700 font-medium">
              📧 Email: <a href="mailto:support@malishusclothify.com" className="font-normal text-purple-600 hover:underline">support@malishusclothify.com</a>
            </p>
            <p className="text-gray-700 font-medium">
