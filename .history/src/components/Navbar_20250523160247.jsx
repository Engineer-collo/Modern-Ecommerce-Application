    ...
    <header className="mt-2 bg-white  shadow-md">
      <div className="max-w-7xl mx-auto px-10 py-10 flex flex-col md:flex-row md:justify-between md:items-center">
        ...
        <nav className="space-x-6 hidden md:flex">
          ...
          <Link
            to="/about"
            className="text-2xl  text-2x hover:text-blue-500 font-bold text-gray-700 transition"
          >
            About
          </Link>
          <Link
          ...
          <Link
            to="/cart"
            className=" text-2xl rounded p-1 font-bold text-orange-700 transition"
          >
            🛒{cart.length}
          </Link>
          <Link
      ...
      {isOpen && (
        <nav className="md:hidden px-4 pb-4 space-y-2">
          {isOpen && (
              ...
              <Link
                to="/cart"
                className="text-xl font-bold text-orange-700 hover:text-orange-500 transition"
              >
                🛒 {cart.length}
              </Link>
              <Link
