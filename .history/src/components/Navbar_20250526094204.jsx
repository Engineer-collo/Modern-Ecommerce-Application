...
{/* Mobile nav */}
{isOpen && (
  <nav className="md:hidden bg-purple-600 text-white px-4 py-6 shadow-lg">
    <div className="flex flex-col items-center space-y-6">
      <Link
        to="/"
        className="text-2xl font-bold hover:text-white hover:underline transition"
      >
        Home
      </Link>
      <Link
      ...
      <Link to="/cart" className="relative text-2xl font-bold hover:text-white transition">
  🛒
  <span className="absolute -top-2 -right-3 bg-red-500 text-white text-xs font-bold px-2 py-0.5 rounded-full">
    {cart.length}
      ...
      <Link
        to="/login"
        className="text-center text-2xl font-bold bg-white text-purple-600 px-6 py-3 rounded-lg shadow-md hover:bg-purple-100 transition"
      >
        Login
      </Link>
    </div>
