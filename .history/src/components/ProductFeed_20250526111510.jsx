...
const ProductFeed = ({ addToCart }) => {
  ...
  const url1 = 'https://videos.pexels.com/video-files/5926067/5926067-uhd_1440_2560_24fps.mp4'

  const url2 = 'https://videos.pexels.com/video-files/8322525/8322525-uhd_1440_2732_25fps.mp4

  const url3 = 'https://www.w3schools.com/html/mov_bbb.mp4'

  const url4 = 'https://www.w3schools.com/html/mov_bbb.mp4'
    ...
    <VideoSlider videos={videos}/>
      <div className="mt-12 p-4 max-w-7xl mx-auto">
        ...
        <div className="mb-10 p-6 rounded-xl shadow-lg bg-gradient-to-r from-purple-600 via-purple-700 to-indigo-700 text-white max-w-xl mx-auto">
          <h1 className="text-2xl font-bold text-center pb-6"> Offer! Offer! Offer!</h1>
          <OfferCountdown />
