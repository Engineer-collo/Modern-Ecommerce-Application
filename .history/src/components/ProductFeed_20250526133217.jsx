...
const ProductFeed = ({ addToCart }) => {
  ...
  const url4 = 'https://videos.pexels.com/video-files/8844336/8844336-sd_360_640_30fps.mp4'
  ...
  muted
  loop
  style="width: 100%; max-width: 800px; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.2);"
/>
