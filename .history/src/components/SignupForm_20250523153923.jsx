...
function SignupForm() {
  return (
    ...
    >
      <Form className="bg-white mt-6  p-6 rounded-lg shadow-md w-80">
        ...
        <button type="submit" className="bg-purple-500 text-white px-4 py-2 rounded w-full">Sign Up</button>
      </Form>
    </Formik>
    </>
  )
